...
title: Data Management Plan for the Study _Do Reputable Open Access Journals Require
  Open Data Sharing_
author: "Principal Investigator - April Clyburne-Sherin, Code Ocean"
date: "August 6, 2018"
...
> "the prevalence of research data policies from institutions and research funders is increasing, so publishers and editors are paying more attention to 
standardisation and the wider adoption of data sharing policies."

This study investigates whether the most reputable Open Access journals have  
data sharing polices and the characteristics of those policies. These policies  require authors, in some fashion, to openly disseminate the data and software  underlying their published articles.
...
a. All original data, code, or reports produced as part of this project are owned by Trieste Polytechnic Institute per its institutional intellectual property policy.
    1. A sub-list.
    1. Another sub-list.
    1. What another sub-list!?!

a. The J. Bohannan Foundation adheres to the open access and data sharing policies of the [Gates Foundation](https://www.gatesfoundation.org/How-We-Work/General-Information/Open-Access-Policy)
...
|Output #(centered)|Digital Output(left)|Type|Format,Duration,Size|Planned access|
|:------:|:-------|:-----------|:----------|:-------------|
...
```
This is an unexecutable code bit.
```
